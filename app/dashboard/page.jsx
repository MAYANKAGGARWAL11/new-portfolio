...
function Dashboard() {
    return (
          <div className="bg-[#F4DEB3] p-6 rounded-lg shadow-lg flex flex-col items-center mt-7">
            {/* Profile Image */}
            <img
              src="/mayank.png"  // Replace with your actual image URL
              alt="Mayank Aggarwal"
              className="w-60 h-43 rounded-full object-cover mb-4 "
            />
            {/* Name */}
            <h2 className="text-2xl font-semibold mb-2 mt-3 text-[#1B262C] ">Mayank Aggarwal</h2>
            {/* Description */}
            <p className="text-center  text-black-600 mt-7">
